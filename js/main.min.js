...
d=h.get("config")||"default",m=h.get("index")||-1,p=null,q=(-1===d.indexOf("/")?"config/":"")+d+(-1===d.indexOf(".")?".json":""),n={},k={},l=[],e=document.getElementsByTagName("main")[0],h=document.getElementsByTagName("footer")[0];h.getElementsByClassName("float-left")[0].innerText="\u26ed "+d;h.removeAttribute("hidden");var f,r;r=function(){var b=l[m],a=g(b,"remoteURL"),d=(a?a:"")+"content/"+b.contentType,c=d+"/html.txt";axios.get(c,{responseType:"text"}).then(function(b){return b.data}).then(function(a){tvDisplay.tvContent&&
