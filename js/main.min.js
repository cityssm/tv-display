var tvDisplay=function(){function h(a,b){var c=a[b];null===c&&m[a.contentType]&&(c=m[a.contentType][b]);null===c&&(c=q[b]);return c}function f(a){axios.get(r,{responseType:"json"}).then(function(a){return a.data}).then(function(b){k=b.contentList||[];m=b.contentDefaults||{};q=b.displayDefaults||{};a&&e()})["catch"](function(a){0===k.length&&window.alert("Unable to load config: "+r+"\n\n"+a)})}var g=new URLSearchParams(window.location.search),n=g.get("config")||"default",l=g.get("index")||-1,p=null,
r="config/"+n+(-1===n.indexOf(".")?".json":""),q={},m={},k=[],d=document.getElementsByTagName("main")[0],g=document.getElementsByTagName("footer")[0];g.getElementsByClassName("float-left")[0].innerText="\u26ed "+n;g.removeAttribute("hidden");var e,t;t=function(){var a=k[l],b="content/"+a.contentType+"/html.txt";axios.get(b,{responseType:"text"}).then(function(a){return a.data}).then(function(c){tvDisplay.content&&(tvDisplay.tvContent.destroy&&tvDisplay.tvContent.destroy(),delete tvDisplay.tvContent);
