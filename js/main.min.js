var tvDisplay=function(){function h(b,a){return b.hasOwnProperty(a)?b[a]:l.hasOwnProperty(b.contentType)&&l[b.contentType].hasOwnProperty(a)?l[b.contentType][a]:p.hasOwnProperty(a)?p[a]:null}function e(b){axios.get(r,{responseType:"json",data:{_:Date.now()}}).then(function(b){return b.data}).then(function(a){m=a.contentList||[];l=a.contentDefaults||{};p=a.displayDefaults||{};b&&g()})["catch"](function(b){0===m.length&&window.alert("Unable to load config: "+r+"\n\n"+b)})}var k=new URLSearchParams(window.location.search),
