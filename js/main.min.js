var tvDisplay=function(){function g(a,b){var c=a[b];!c&&m[a.contentType]&&(c=m[a.contentType][b]);c||(c=q[b]);return c}function h(a){axios.get(r,{responseType:"json"}).then(function(a){return a.data}).then(function(b){k=b.contentList||[];m=b.contentDefaults||{};q=b.displayDefaults||{};a&&e()})["catch"](function(a){0===k.length&&window.alert("Unable to load config: "+r+"\n\n"+a)})}var f=new URLSearchParams(window.location.search),n=f.get("config")||"default",l=f.get("index")||-1,p=null,r="config/"+
n+(-1===n.indexOf(".")?".json":""),q={},m={},k=[],d=document.getElementsByTagName("main")[0],f=document.getElementsByTagName("footer")[0];f.getElementsByClassName("float-left")[0].innerText=n;f.removeAttribute("hidden");var e,t;t=function(){var a=k[l],b="content/"+a.contentType+"/html.txt";axios.get(b,{responseType:"text"}).then(function(a){return a.data}).then(function(c){tvDisplay.content&&(tvDisplay.tvContent.destroy&&tvDisplay.tvContent.destroy(),delete tvDisplay.tvContent);for(;d.firstChild;)d.removeChild(d.firstChild);
